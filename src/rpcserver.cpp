...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Verizon server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Verizon features */
        {"vrz", "masternode", &masternode, true, true, false},
        {"vrz", "listmasternodes", &listmasternodes, true, true, false},
        {"vrz", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vrz", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vrz", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vrz", "masternodedebug", &masternodedebug, true, true, false},
        {"vrz", "startmasternode", &startmasternode, true, true, false},
        {"vrz", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vrz", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vrz", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vrz", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vrz", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vrz", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vrz", "mnbudget", &mnbudget, true, true, false},
        {"vrz", "preparebudget", &preparebudget, true, true, false},
        {"vrz", "submitbudget", &submitbudget, true, true, false},
        {"vrz", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vrz", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vrz", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vrz", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vrz", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vrz", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vrz", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vrz", "checkbudgets", &checkbudgets, true, true, false},
        {"vrz", "mnsync", &mnsync, true, true, false},
        {"vrz", "spork", &spork, true, true, false},
        {"vrz", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vrz", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vrzd, or the -server option to vrz-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vrz-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51416/\n";
}
