...
void PrivatesendConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("Privatesend Configuration"),
        tr(
            "Privatesend was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening Verizon's configuration screen.")
            .arg(strAmount));
...
void PrivatesendConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("Privatesend Configuration"),
        tr(
            "Privatesend was successfully set to high (%1 and 8 rounds). You can change this at any time by opening Verizon's configuration screen.")
            .arg(strAmount));
...
void PrivatesendConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("Privatesend Configuration"),
        tr(
            "Privatesend was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening Verizon's configuration screen.")
            .arg(strAmount));
...
void PrivatesendConfig::configure(bool enabled, int coins, int rounds)
{
    ...
    settings.setValue("nAnonymizeVrzAmount", coins);

    nPrivatesendRounds = rounds;
    nAnonymizeVrzAmount = coins;
}
