...
/** Utility functions used by the Verizon Qt UI.
 */
namespace GUIUtil
{
...
// Render Verizon addresses in monospace font
...
// Parse "vrz:" URI into recipient object, return true on successful parsing
