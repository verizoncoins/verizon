                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Verizon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Verizon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vrz: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Verizon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Verizon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Verizon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Verizon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Verizon addresses"));
    ...
    openAction->setStatusTip(tr("Open a Verizon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Verizon Core help message to get a list with possible Verizon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Verizon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Verizon network", "", count));
}
...
{
    QString strTitle = tr("Verizon Core"); // default title
