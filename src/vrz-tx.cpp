...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Verizon Core vrz-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vrz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vrz transaction") + "\n" +
                               "  vrz-tx [options] -create [commands]   " + _("Create hex-encoded vrz transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vrz transaction
