...
RESOURCES += src/qt/vrz.qrc src/qt/vrz_locale.qrc

TRANSLATIONS += src/qt/locale/vrz_bg.ts \
                src/qt/locale/vrz_de.ts \
                src/qt/locale/vrz_en.ts \
                src/qt/locale/vrz_es.ts \
                src/qt/locale/vrz_fi.ts \
                src/qt/locale/vrz_fr.ts \
                src/qt/locale/vrz_it.ts \
                src/qt/locale/vrz_ja.ts \
                src/qt/locale/vrz_pl.ts \
                src/qt/locale/vrz_pt.ts \
                src/qt/locale/vrz_ru.ts \
                src/qt/locale/vrz_sk.ts \
                src/qt/locale/vrz_sv.ts \
                src/qt/locale/vrz_vi.ts \
                src/qt/locale/vrz_zh_CN.ts \
                src/qt/locale/vrz_zh_TW.ts
