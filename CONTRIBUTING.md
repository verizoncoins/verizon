# Contributing to Verizon Core

The Verizon Core project operates an open contributor model where anyone is
...
- _Tests_ for changes to the vrz unit tests or QA tests
...
The following applies to code changes to the Verizon Core project, and is not to be
confused with overall Verizon Network Protocol consensus changes.

Whether a pull request is merged into Verizon Core rests with the project merge
...
Patches that change Verizon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Verizon consensus, it must have been
...
The project leader is the release manager for each Verizon Core release.
